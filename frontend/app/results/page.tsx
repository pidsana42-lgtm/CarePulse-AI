...
export default function ResultsPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <SiteHeader />
      <main className="flex-1 py-10 px-4 sm:px-6 max-w-3xl mx-auto w-full space-y-6 pb-12">
        {/* Header Banner */}
        <div className="bg-primary text-primary-foreground rounded-2xl p-6 sm:p-8 shadow-lg flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-1.5 opacity-90 text-xs font-bold uppercase tracking-wider mb-1">
        ...
        {result.recommendations.length > 0 && (
          <div className="bg-muted border border-border rounded-2xl p-5 space-y-2">
            ...
            <ul className="space-y-1.5 text-muted-foreground text-sm sm:text-base font-medium">
        ...
        <div className="bg-card border border-border rounded-2xl p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-bold text-foreground">สายด่วน สปสช. สอบถามสิทธิบัตรทอง</div>
              <div className="text-xs text-muted-foreground">โทรฟรีตลอด 24 ชั่วโมง</div>
            </div>
          </div>
          <a
            href="tel:1330"
            className="bg-primary hover:opacity-90 text-primary-foreground font-extrabold px-6 py-2.5 rounded-xl text-base shadow-sm"
          >
            โทร 1330
          </a>
        </div>
        ...
        <div className="text-center pt-4 print:hidden">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground font-bold text-base"
          >
