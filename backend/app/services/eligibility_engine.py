        ...
        if request.age >= 60 or is_bedridden:
            ...
            additional_rights.append(
                HealthcareRightDetail(
                    ...
                    scheme_name="สิทธิกองทุนสุขภาพตำบลและการดูแลระยะยาวผู้มีภาวะพึ่งพิง",
                    ...
                    is_eligible=True,
                    coverage_summary="สิทธิเบิกรับผ้าอ้อมผู้ใหญ่ แผ่นรองซับ กายอุปกรณ์ พร้อมผู้จัดการดูแลและผู้ช่วยเหลือดูแลเยี่ยมบ้านโดยไม่มีค่าใช้จ่าย",
                    free_items=[
                        "ผ้าอ้อมผู้ใหญ่และแผ่นรองซับการขับถ่ายโดยไม่มีค่าใช้จ่าย ไม่เกิน 3 ชิ้นต่อวัน ตามเกณฑ์คะแนนประเมินกิจวัตรประจำวันไม่เกิน 11",
                        "ทีมผู้ช่วยเหลือดูแลผู้สูงอายุลงพื้นที่ดูแลสุขภาพและกายภาพที่บ้าน",
                    ...
                    how_to_use="ให้ญาติหรือผู้ดูแลนำบัตรประชาชนและประวัติการรักษาติดต่อ อบต. เทศบาล หรือ รพ.สต. ในพื้นที่เพื่อประเมินความสามารถในการทำกิจวัตรประจำวัน",
